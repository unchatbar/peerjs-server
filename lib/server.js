...
app._initializeHTTP = function() {
  ...
  this.post('/:key/:id/:token/id',jsonParser,this._options.preprocess, function(req, res, next) {
...
app._pingPong = function (socket) {
    var pingSent = 0,
        maxPingsMissed = this._options.max_pings_missed,
        i;
